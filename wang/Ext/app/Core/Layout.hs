...
layoutWords = [( TokSymbol "seg" 12
               , LayoutDelimiters (TokSymbol ";" 8) (Just (TokSymbol "{" 13)) (Just (TokSymbol "}" 14))
               )]
...
layoutSep   = List.nub $ TokSymbol ";" 8 : map (delimSep . snd) layoutWords
...
resolveLayout topLayout =
  ...
  topDelim = LayoutDelimiters (TokSymbol ";" 8) Nothing Nothing
