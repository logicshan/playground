...
\begin{itemize}
  ...
  \item 我们证明 $\bar{A_x}\triangleq\lambda(\ul:\ttone)\to A\,x : \ttone\to\calU$ 上有一个纤维化结构
  \item $\gamma \triangleq \lambda(\ul:\ttone)\to x : \ttone \to \Gamma$
  \item 我们要证明 $(\bar{A_x},\alpha[\gamma]) \in \Fib\,\ttone$
  \item $(A,\alpha)[\gamma]$ 就满足要求
  \item 按定义, $\bar{A_x} = A\circ\gamma$
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item \begin{align*}\isFib\ \ttk Pi &\triangleq &&(e:\{\ttzero,\ttone\})(p:\ttI\to\ttone)\to\Comp\ e\ (\ttk Pi \circ p) \\
       ...
       &&&\{a_1:(\ttk Pi \circ p)\,\bar{e}\mid(\varphi,f)\,@\,\bar{e}\nearrow a_1 \}\\
       &\triangleq&&(e:\{\ttzero,\ttone\})(p:\ttI\to\ttone)\to (\varphi:\Cof)(f:[\varphi]\to\Pi_{\ttI}(\ttk Pi \circ p)) \to\\
       &&&\{ a_0 : P\,i \mid (\varphi,f)\,@\,e \nearrow a_0 \} \to \\
       &&&\{a_1:P\,i \mid(\varphi,f)\,@\,\bar{e}\nearrow a_1 \}
  \end{align*}
\end{itemize}
\end{frame}
...
\begin{itemize}
  \item \begin{align*}\isFib\ P &\triangleq &&(e:\{\ttzero,\ttone\})(p:\ttI\to\ttI)\to\Comp\ e\ (P \circ p) \\
       ...
       &&&\{a_1:(P \circ p)\,\bar{e}\mid(\varphi,f)\,@\,\bar{e}\nearrow a_1 \}
  \end{align*}
