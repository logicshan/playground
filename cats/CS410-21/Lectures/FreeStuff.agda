...
module Lectures.FreeStuff where

open import Data.List as List
open import Data.List.Properties
  using (++-assoc; ++-identityʳ; map-id; map-++; map-∘)
...
module _ where
  ...
  preserves-∙ (fmap freeMonoid f) xs ys = map-++ f xs ys
  identity freeMonoid = eqMonoidMorphism (ext map-id)
  homomorphism freeMonoid = eqMonoidMorphism (ext map-∘)
